...
namespace Genealogy.Infrastructure.Migrations
{
    ...
    [Migration("20231230142939_RenameAuthTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Genealogy.Domain.Data.Auth.Permission", b =>
                {
            ...
            modelBuilder.Entity("Genealogy.Domain.Data.Auth.RefreshTokenData", b =>
                {
                    ...
                    b.ToTable("auth_refresh_token_data", (string)null);
                });

            modelBuilder.Entity("Genealogy.Domain.Data.Auth.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Genealogy.Domain.Data.Auth.RsaKey", b =>
                {
                    ...
                    b.ToTable("auth_rsa_keys", (string)null);
                });

            modelBuilder.Entity("Genealogy.Domain.Data.Auth.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Genealogy.Infrastructure.Data.Configurations.Auth.RoleConfiguration+RolePermission", b =>
                {
            ...
            modelBuilder.Entity("Genealogy.Infrastructure.Data.Configurations.Auth.RoleConfiguration+RoleMember", b =>
                {
                    b.HasOne("Genealogy.Domain.Data.Auth.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Genealogy.Domain.Data.Auth.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Genealogy.Infrastructure.Data.Configurations.Auth.RoleConfiguration+RolePermission", b =>
                {
                    b.HasOne("Genealogy.Domain.Data.Auth.Permission", null)
                        .WithMany()
